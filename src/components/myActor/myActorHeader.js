...
export default function MyActorsHeader() {
    ...
    return (
        <>
            <div className="sm:px-20 flex justify-between sm:flex-row flex-col pt-3">
                <h1 className="sm:text-5xl text-4xl text-white font-black text-center sm:pt-0 py-10">My Actors</h1>
